# Pipery Ansible CD Component

Reusable GitLab CI/CD component for complete Ansible deployment pipeline with structured logging.

## Overview

This component provides a complete CD (deployment) pipeline using Ansible:
- Image/artifact pull
...
```yaml
include:
  - component: $CI_SERVER_FQDN/pipery-dev/pipery-ansible-cd/catalog-resources/pipery-ansible-cd@main
